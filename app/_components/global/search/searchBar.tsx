    ...
    return (
        <div className="relative w-full max-w-sm">
            <div className="flex items-center bg-off-white border border-gray rounded-lg focus-within:ring-1 focus-within:ring-blue-500 focus-within:border-blue-500">
                ...
                <input name="search" type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} onKeyPress={handleKeyPress} placeholder={`Search ${searchType}...`} className="flex-1 px-4 py-2 focus:outline-none text-medium-blue text-sm" style={{ paddingLeft: "0.5rem" }} />
                <button type="button" onClick={handleSearch} className="mr-1 px-2 py-2 bg-brand-blue hover:bg-blue-600 transition-colors rounded-lg" aria-label="Search">
